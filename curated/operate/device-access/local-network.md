...
To make the change persistent across updates, add the key through the `_config/pvr-sdk/` overlay in your `pvr` checkout (see [Configure Applications](/develop/application/configure)).