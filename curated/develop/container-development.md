...
For xconnect service manifest details and supported service types (unix, rest, dbus, drm, wayland), see the [pantavisor xconnect reference](/reference/pantavisor/reference/pantavisor-xconnect) or [pantavisor/docs/overview/xconnect.md](/reference/pantavisor/overview/xconnect).
