...
:::note
All states are independent from the [Pantavisor state machine](pantavisor-architecture.md#staet-machine), but all their associated processes are run from its WAIT state.
:::
